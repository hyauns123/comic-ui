...
import { Edit, Eye, Trash2, Book } from "lucide-react"
              ...
              <tr key={author.id}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  <div className="d-flex gap-2">
                    <Link href={`/authors/${author.id}`} passHref legacyBehavior>
                      <Button as="a" variant="outline-info" size="sm">
                        <Eye size={14} />
                      </Button>
                    </Link>
                    <Link href={`/admin/authors/edit/${author.id}`} passHref legacyBehavior>
